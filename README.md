This is the **second** released version of the Brute Force Gimkit Joiner. 
Give any feedback on how my script could be improved please!

Bug Fixes:
- _The script now stops itself properly upon reaching the name prompt._

Changed/New Features:
- _Added miss counter before the script stops itself, can be adjusted to your liking_
- _Removed the required use of YourName.png_
...
You will need to contain these 2 images for the script to function correctly; you can contain them here or screenshot them in the Gimkit Join screen—**png images are recommended**:
<img width="167" height="38" alt="GameCode" src="https://github.com/user-attachments/assets/d7220962-f6c8-4937-8635-2e83768061be" />
<img width="500" height="64" alt="Join" src="https://github.com/user-attachments/assets/1761bd7d-0bc8-4af8-baf5-438c1b383c0a" />

[Python_Images.zip](https://github.com/user-attachments/files/23760637/Python_Images.zip)
