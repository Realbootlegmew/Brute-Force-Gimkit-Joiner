...
[BruteForceGimkitV1.py](https://github.com/user-attachments/files/23748673/BruteForceGimkitV1.py)
...
**If the script doesn't work running, mvoe your cursor to the bottom left to forcefully stop it.**
